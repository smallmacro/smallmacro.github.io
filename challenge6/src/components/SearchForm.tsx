  ...
  return (
    ...
    <form className='h-[5rem] bg-white -mt-10 rounded-md flex flex-row pl-6 pr-4 justify-between md:gap-x-4 xl:gap-x-6 items-center md:px-6  ' action="" method="post">
      <label htmlFor="title" className='flex flex-row md:items-center md:gap-x-4 md:flex-1 md:py-5 md:border-r md:border-darkgrayop20 '>
        ...
        <input type="text" name="title" id="title" placeholder='Filter by title,companies,expertise...' className='appearance-none border-0 text-darkblue dark:text-white placeholder:text-darkblueop50 placeholder:dark:text-white focus:ring-0 md:px-0 md:max-w-[168px]'/>
      </label>
      ...
      <label htmlFor="isFullTime" className='hidden md:flex flex-row  md:gap-x-4  md:py-5 md:max-w-[108px] xl:max-w-[168px] xl:flex-1 truncate'>
