    ...
    <div className='flex flex-row px-6 py-9 justify-between'>
      ...
      <div className='flex flex-row gap-x-4 items-center'>
        ...
        <label htmlFor="modeToggle" className='inline-flex cursor-pointer relative '>
          ...
          <div className="w-12 h-6 bg-white peer-focus:outline-none  rounded-xl peer peer-checked:after:translate-x-full  after:content-[''] after:absolute after:top-[5px] after:left-[5px] after:voilet   after:rounded-xl after:h-[14px] after:w-[14px] after:transition-all after:bg-voilet hover:after:bg-lightvoilet"></div>
        </label>
