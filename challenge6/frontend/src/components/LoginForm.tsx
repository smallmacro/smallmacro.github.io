  ...
  return (
    <div className=' flex flex-col items-center mx-6 md:mx-10 max-w-[1110px] xl:mx-auto py-12 gap-y-4 text-darkgray'>
      ...
      <label htmlFor="username" className='w-full'>
        <input type="text" name="username" id="username" placeholder='Enter your username' value={username} className='w-full' onChange={(e) => setUsername(e.target.value)}/>
      </label>
      ...
      <label htmlFor="submitBtn" className='w-full  '>
        <button type="submit" className='bg-voilet text-white rounded-xl font-bold px-6 py-2 w-full'>Sign In</button>
      </label>
